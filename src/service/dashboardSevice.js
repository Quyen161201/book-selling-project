...
module.exports = {
    dashboardSevice: async () => {
        try {
            ...
            let [list_bill] = await connection.query('select cc.name,o.orderId, o.create_at ,o.status ,o.invoice ,o.totalOrder  from orderdetails o,contact_customer cc where  o.contact_id =cc.id')
